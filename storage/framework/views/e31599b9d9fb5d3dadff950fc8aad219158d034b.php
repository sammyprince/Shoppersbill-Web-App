	...
	<div class="<?php echo e($col_class, false); ?>">
		<div class="form-group">
			...
			<div class="input-group">
				...
				?>
				<?php echo Form::select("payment[$row_index][method]", $payment_types, $_payment_method, ['class' => 'form-control select2 col-md-12 payment_types_dropdown', 'required', 'id' => !$readonly ? "method_$row_index" : "method_advance_$row_index", 'style' => 'width:100%;', 'disabled' => $readonly]);; ?>
...
</div><?php /**PATH /home/admin/web/pos.shoppersbill.com/public_html/resources/views/sale_pos/partials/payment_row_form.blade.php ENDPATH**/ ?>