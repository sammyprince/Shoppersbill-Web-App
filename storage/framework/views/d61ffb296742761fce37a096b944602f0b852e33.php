...
<!-- Main Header -->
      ...
      <div class="navbar-custom-menu">
        ...
        <?php if(in_array('pos_sale', $enabled_modules)): ?>
          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sell.create')): ?>
            <a href="<?php echo e(action('SellPosController@create'), false); ?>" title="<?php echo app('translator')->getFromJson('sale.pos_sale'); ?>" data-toggle="tooltip" data-placement="bottom" class="btn btn-success btn-flat pull-left m-8 hidden-xs btn-sm mt-10">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <?php if(!empty(Session::get('business.logo'))): ?>
                  <img src="<?php echo e(asset( 'uploads/business_logos/' . Session::get('business.logo') ), false); ?>" alt="Logo"></span>
                <?php endif; ?>
                <p>
  ...
  </header><?php /**PATH /home/admin/web/pos.shoppersbill.com/public_html/resources/views/layouts/partials/header.blade.php ENDPATH**/ ?>