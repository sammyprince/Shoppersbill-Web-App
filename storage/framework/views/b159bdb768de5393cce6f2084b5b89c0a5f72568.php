...
<div class="form-group col-md-3">
    <?php echo Form::label('contact_number', __( 'lang_v1.contact_no' ) . ':'); ?>

    <?php echo Form::text('contact_number', !empty($user->contact_number) ? $user->contact_number : null, ['class' => 'form-control', 'placeholder' => __( 'lang_v1.contact_no') ]);; ?>
...
</div><?php /**PATH /home/admin/web/pos.shoppersbill.com/public_html/resources/views/user/form.blade.php ENDPATH**/ ?>