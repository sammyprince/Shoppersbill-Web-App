		...
		<table class="table table-responsive table-slim">
			<thead>
				<tr>
					...
					<th class="text-right"><?php echo e($receipt_details->table_qty_label, false); ?></th>
					<th class="text-right"><?php echo e($receipt_details->table_unit_price_label, false); ?></th>
...
<?php endif; ?><?php /**PATH /home/benignanttg/pos.shoppersbill.com/resources/views/sale_pos/receipts/classic.blade.php ENDPATH**/ ?>