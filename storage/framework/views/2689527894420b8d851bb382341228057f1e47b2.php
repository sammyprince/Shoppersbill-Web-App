...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson('lang_v1.bulk_edit_products'); ?></h1>
</section>
		...
		<div class="col-md-12">
			<table class="table text-center table-bordered" id="product_table">
				<thead id="product_table_head">
					<tr class="bg-gray">
						<th class="col-md-1"><?php echo app('translator')->getFromJson('sale.product'); ?></th>
						<th class="col-md-2"><?php echo app('translator')->getFromJson('product.category'); ?></th>
						<th class="col-md-2"><?php echo app('translator')->getFromJson('product.sub_category'); ?></th>
						<th class="col-md-2"><?php echo app('translator')->getFromJson('product.brand'); ?></th>
                		<th class="col-md-2"><?php echo app('translator')->getFromJson('product.tax'); ?></th>
                		<th class="col-md-3"><?php echo app('translator')->getFromJson('business.business_locations'); ?></th>
					</tr>
				</thead>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/benignanttg/pos.shoppersbill.com/resources/views/product/bulk-edit.blade.php ENDPATH**/ ?>